...
# 2. Install the most recent version of tidycmprsk

# 3. Restart R to have a fresh R session.
#    No packages should be loaded, not even tidycmprsk.
...
gt.doc.images::save_help_file_images(pkg = "tidycmprsk")

# 5. Shrink png files
gt.doc.images::shrink_help_file_images(pkg = "tidycmprsk")
